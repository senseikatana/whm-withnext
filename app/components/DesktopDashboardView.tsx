...
export default function DesktopDashboardView({
  ...
  const hasData =
    ...
    dbState.orders.length > 0 ||
    dbState.picking.length > 0;
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <KpiCard
          ...
          subtitle={
            hasData ? "Muelles de descarga activos" : "Sin recepciones"
          }
        ...
        <KpiCard
          ...
          value={criticalStock}
          subtitle={
            hasData ? "Artículos bajo stock mínimo" : "Sin inventario"
          }
          icon={AlertTriangle}
      ...
      {!hasData ? (
        <div className="bg-[#050811] border border-slate-800 rounded-2xl p-12 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-sm text-slate-400 max-w-md mb-6">
            Conecta tu base de datos InsForge o genera datos mock en cada módulo
            para comenzar a ver el dashboard operativo.
          </p>
            ...
            <div className="flex justify-between items-center mb-4">
              <div>
                <h3 className="font-bold text-sm text-white">
                  Volumen de Movimiento Diario
                </h3>
                <p className="text-xs text-slate-400">
                  Entradas vs Salidas de palets
                </p>
              </div>
