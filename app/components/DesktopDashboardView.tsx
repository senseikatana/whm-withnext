    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        <KpiCard
          title={t.compRate}
          value={serviceLevel}
          subtitle="vs 96.2% el mes anterior"
          icon={CheckCircle2}
          trend="+2.2%"
          trendUp={true}
        />
        <KpiCard
          ...
          subtitle="Muelles de descarga activos"
        ...
        <KpiCard
          ...
          subtitle="En cola de expedición"
          icon={Send}
        />
        <KpiCard
          title={t.lowStock}
          value={criticalStock}
          subtitle="Artículos bajo stock mínimo"
          icon={AlertTriangle}
          trend={criticalStock > 0 ? "Crítico" : "Óptimo"}
        ...
        <div className="bg-[#050811] border border-slate-805 p-5 rounded-2xl lg:col-span-2 flex flex-col justify-between">
          ...
          <div className="flex space-x-4 mt-3 text-xs justify-center font-medium">
            ...
            <span className="flex items-center gap-1.5 text-slate-400">
              <span className="w-2 h-2 rounded-full bg-indigo-350" />
              Salidas
            </span>
          </div>
        </div>
